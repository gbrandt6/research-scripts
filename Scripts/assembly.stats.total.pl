...
print OUT "Total seqs: ", $total, "\n";
print OUT "Total length: ", $sum, "\n";

#close files
close OUT;

sub usage {
    print "This code finds the total value from the second column of a file\n";
    print "Perhaps for a file with GC content or Length per contig\n";
    print "How to run this code:\n";
    print "assembly.stats.total.pl input.file output.file.name\n";
}
