...
sub usage {
  ...
  print "./FastQ.length.pl -i [input fasta file] -o [optional output file, prints length of each sequence] > output.txt\n";
...
print $total_length / ($counter / 2), "\n";
print "Median sequence length:\t";
print $lengths[(($counter / 2) / 2)], "\n";
